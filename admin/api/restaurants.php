...
if ($method === 'PUT') {
    ...
    $body = getJsonBody();
    $fields=[]; $params=[];
    foreach(['name_ar','name_en','slug','address_ar','address_en','phone','maps_url','logo','bg_image','primary_color','show_vip','show_gallery','show_tutorial','show_cart','show_parallax','show_hub','show_vip_prices'] as $f) {
